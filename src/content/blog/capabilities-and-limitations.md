...
description: Week Two with AI
pubDate: 2026-08-30T18:02:00.000-04:00
draft: false
---
It’s been two weeks since I started using AI as a multi-agent workshop and right now, my primary capabilities are limited as I try to type with two puppies vying for my attention. Aptly named, I’ll be exploring Capabilities and Limitations that I’ve discovered this past week.
...
“What can you do for me with ‘X’ background information?”

“What are you best at?”

Turns out Gemini was just what I needed for all the concept art I was generating. I was doing so many iterative adjustments in GPT, I hit my limits extremely quickly, but Gemini just let me keep going. And while I liked the notebook style organization more, it didn’t take me long to get it on board with my projects in GPT with the PDF summaries I had generated.

From there I decided to start Project Pavlov to collect all my dog photos, videos, and records. But that was a little side project of my own undertaking. I’ll expand more on that later depending on how puppy training goes.

I got my first taste of a multi-agent workflow though. And that allowed me to organize in GPT, refine concept art in Gemini, and then use GPT for final iterations and bring the art to life for the website. So it’s not like I haven’t been actively working on the website. There are just a lot of elements I need in place before I’m ready to push version 1. That and GPT understood the entire branding theme and could publish the finished concept art without a watermark.

That’s a limitation Gemini. PAID TIER IS A LIMITATION!

But I digress.

Even that process could be automated though and of course that always begs the question:

“How?”

And we decided to explore exactly that. GPT seemed pretty good at some rudimentary HTML coding for a webpage. But could it do more? I asked both GPT and Gemini who they would recommend for coding with the way I wrote and prompted them.

My thought was to pit them against each other.

The recommendation was Claude.
...
Because that’s just what kind of person I am. I don’t want to just “vibe code” my way to a website. I want to understand how every little piece of it I build works.
...
Apps still force you into a box and have their uses. But the key point is to just have fun with it.
And if I’m building things I can actually use, why shouldn’t I invest my time into such a venture? All I’ve been doing in my spare time is putting in job applications and waiting around anyway. Might as well be productive with my time.

But there was a second key hidden in there. Not just fun, but what if I built the applications that I always wanted to have as a writer? As a gamer? As a guitarist?

But the third key I think is what holds it all together.

Not just the fun of it.

Not just making things I wish I had growing up.

But the fact that I’m approaching all of this as an experiment and I keep asking:

“What would happen if I push this button next?”
...
Next week, we’ll push some models and tools a bit more to find their more broad limitations. Gemini still hasn’t shut us down on image generation and we’ve been pushing it a lot. Maybe I’ll get some website work done. Maybe I’ll start on Daedalus projects. The point is, right now, I have options.

I think the best way to end this post is simply.

If you decide to approach AI and introduce it into your workflow, remember these three keys:
